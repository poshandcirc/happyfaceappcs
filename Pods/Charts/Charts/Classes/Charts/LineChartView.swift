...
// chartOneBarlineChartViewBase = BarLineChartViewBase()
// chartOneLineChartDataProvider = LineChartDataProvider()

// let chartOne = LineChartView(chartOneBarlineChartViewBase,chartOneLineChartDataProvider)
