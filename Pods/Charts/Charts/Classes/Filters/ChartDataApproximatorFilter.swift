...
open class ChartDataApproximatorFilter: ChartDataBaseFilter
{
    ...
    fileprivate func reduceWithDouglasPeuker(_ entries: [ChartDataEntry], epsilon: Double) -> [ChartDataEntry]
    {
    ...
    /// - parameter start:
    /// - parameter end:
    fileprivate func algorithmDouglasPeucker(_ entries: [ChartDataEntry], epsilon: Double, start: Int, end: Int, keep: inout [Bool])
    {
        if (end <= start + 1)
        {
            // recursion finished
    ...
    fileprivate func calcPointToLineDistance(_ startEntry: ChartDataEntry, endEntry: ChartDataEntry, entryPoint: ChartDataEntry) -> Double
    {
    ...
    fileprivate func calcAngleBetweenLines(_ start1: ChartDataEntry, end1: ChartDataEntry, start2: ChartDataEntry, end2: ChartDataEntry) -> Double
    {
    ...
    fileprivate func calcAngleWithRatios(_ p1: ChartDataEntry, p2: ChartDataEntry) -> Double
    {
    ...
    fileprivate func calcAngle(_ p1: ChartDataEntry, p2: ChartDataEntry) -> Double
    {
